...
class UserInfo(models.Model):
    ...
    personHeight = models.CharField(max_length=20, default='', verbose_name='身高')
    personWeight = models.CharField(max_length=20, default='', verbose_name='体重')
    ...
    def getJsonObj(self):
        userInfo = {
            ...
            'personHeight': self.personHeight,
            'personWeight': self.personWeight,
